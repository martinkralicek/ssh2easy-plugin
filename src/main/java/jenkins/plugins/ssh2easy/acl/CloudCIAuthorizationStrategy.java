...
public class CloudCIAuthorizationStrategy extends AuthorizationStrategy {
    ...
    private final Map<AclType, CloudProject> cloudProjects = new EnumMap<AclType, CloudProject>(AclType.class);
    ...
    public ACL getACL(Job<?, ?> project) {
        ...
        if (cloudProject == null) {
            ...
            acl = cloudProject.newAuthorizationStrategyCloudProject(project.getName()).getACL().newInheritingACL(getRootACL());
        }
        return acl;
    }
    ...
    public static final class DescriptorImpl extends GlobalMatrixAuthorizationStrategy.DescriptorImpl {
        ...
        public void doProjectsSubmit(StaplerRequest req, StaplerResponse rsp) throws UnsupportedEncodingException, ServletException, FormException, IOException {
